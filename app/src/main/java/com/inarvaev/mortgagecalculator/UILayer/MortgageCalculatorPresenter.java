...
class MortgageCalculatorPresenter implements IMortgageCalculatorPresentationLogic {

    private IMortgageCalculatorDisplayLogic mMortgageCalculatorDisplayLogic;

    MortgageCalculatorPresenter(IMortgageCalculatorDisplayLogic mortgageCalculatorDisplayLogic) {
    ...
    public void presentLoanRate(BigDecimal loanRate, int firstPayment, int fullLoanPrice, int paymentPeriod, int oneMonthPayment) {
        ...
        String message = String.format(
                ...
                "Месячный платеж по кредиту (руб): %d.",
                                            localLoanRate.toPlainString(),
                                            fullLoanPrice,
                                            paymentPeriod,
                                            oneMonthPayment);
